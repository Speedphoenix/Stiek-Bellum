...
void update(Tile carte[MAPSIZEX][MAPSIZEY], Ancre *ancre, std::list<Build *>& ancre_b, Joueur& joueur);
...
void automat(Ancre& ancre, std::list<Build *>& ancre_b, Tile carte[MAPSIZEX][MAPSIZEY], Joueur& joueur, Unit& unite);
